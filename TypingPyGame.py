...
clouds = Clouds('img/finalcloud.png', (500,0), 10, 'img/cloud.png')
...
score = Score()
victor = Animation_End(0, -15, 'img/Victor.png', [6, -48], [100, 90], 0)
animationEnd_group = pygame.sprite.Group()
animationEnd_group.add(victor)
adel = Animation_End(-1, -15, 'img/Adel.png', [-50, -35], [80, 95], 25)
animationEnd_group.add(adel)
eduardo = Animation_End(3, -15, 'img/Eduardo.png', [120, 20], [80, 95], -35)
animationEnd_group.add(eduardo)
hannah = Animation_End(2, -15, 'img/Hannah.png', [90, -15], [100, 85], -35)
animationEnd_group.add(hannah)
changwook = Animation_End(-3, -15, 'img/changwook.png', [-103, 18], [160, 170], 43)
animationEnd_group.add(changwook)
helen = Animation_End(-2, -15, 'img/Helen.png', [-70, -10], [160, 150], 20)
animationEnd_group.add(helen)
sadhana = Animation_End(1, -15, 'img/Sadhana.png', [46, -40], [140, 150], -20)
animationEnd_group.add(sadhana)
arvind = Animation_End(-2, -15, 'img/Arvind.png', [80,10], [100,105], 0)
...
while 1:
	...
	if gameState == GameState.TITLE:
		...
		word = text.get_word()
		screen.fill((255, 255, 255))
		bg = pygame.transform.scale(pygame.image.load("img/background.jpg"), [1024,768])
		screen.blit(bg, (0,0))
